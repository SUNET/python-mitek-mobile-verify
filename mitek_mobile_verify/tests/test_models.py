...
class TestPhotoVerifyAdvancedRequest(unittest.TestCase):
    ...
    def test_response_image_types(self):
        ...
        self.request.response_image_types = None
        self.assertEqual(None, self.request.response_image_types)
    ...
    def test_back_image(self):
        ...
        image = self.request.create_image(image_data=base64.b64encode(b'base64str'))
        self.request.back_image = image
        self.assertEqual(self.request.back_image, image)
    ...
    def test_esf_detection(self):
        ...
        esf_detection = self.request.create_esf_detection(performed_evaluation=True)
        self.request.esf_detection = esf_detection
        self.assertEqual(self.request.esf_detection, esf_detection)
    ...
    def test_to_dict_full(self):
        ...
        self.assertEqual(self.request.to_dict(), ref_dict)
    ...
    def test_to_dict_with_none(self):
        ...
        self.request.response_image_types = None
        self.request.back_image = self.request.create_image(image_data=base64.b64encode(b'base64str'))
        self.request.expected_name = self.request.create_name()
        self.request.front_image = self.request.create_image(image_data=base64.b64encode(b'base64str'))
        self.request.issue_date = datetime(2017, 1, 23, 14, 3, 16, 76723)
        self.request.state_abbr = 'AL'
        self.request.esf_detection = self.request.create_esf_detection(performed_evaluation=True)
